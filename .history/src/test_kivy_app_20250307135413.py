...
class DrumMachineGUI(BoxLayout):
    ...
    def initialize_audio(self):
        try:
            ...
            fs.program_select(0, drum_sfid, 128, 0)  # Try bank 128 (standard GM drum bank)
            fs.cc(0, 7, 100)  # Set drum volume

            # Try to set up some specific drum sounds
            fs.program_change(0, 0)  # Set to standard drum kit
