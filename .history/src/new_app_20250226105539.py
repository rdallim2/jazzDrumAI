...
def choose_next_phrase(tempo, player_count):
    ...
    if player_count == 2:
        ...
        comp_amount_choice = drum_comp_vs_time_matrix[den][vol]
        comp = ['y', 'n']
