...
class DrumMachineGUI(BoxLayout):
    ...
    def initialize_audio(self):
        try:
            ...
            fs.cc(0, 7, 100)  # Set piano volume
            ...
            # Set up drums on channel 10
            fs.sfont_select(10, drum_sfid)  # Select drum soundfont for drum channel
            fs.program_select(10, drum_sfid, 0, 0)  # Drums on channel 10
