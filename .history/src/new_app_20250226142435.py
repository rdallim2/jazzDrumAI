...
try:
    ...
    bass_sfid = fs.sfload("FluidR3_GM.sf2")  
    fs.program_select(0, bass_sfid, 0, 32)  # 0 is the channel, 32 is the bank for fingered bass
...
def main():
    ...
    if players == 0:
        ...
        bass_thread = threading.Thread(target= play_bar, args=(tempo, blues_progression[0], 12) )
