...
def run_guitar(time_per_beat, guitar_channel=2):
    """
    This function will continuously play guitar comping
    """
    print(f"Bass started on channel {guitar_channel}")
    try:
        # Use the walking_bass_line function from bass_blues.py for a more interesting bass line
        guitar_comp(fs, time_per_beat, guitar_channel)
    except Exception as e:
        print(f"Error in guitar thread: {e}")
