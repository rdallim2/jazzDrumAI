...
class DrumMachineGUI(BoxLayout):
    def __init__(self, **kwargs):
        ...
        lead_sheet_title_box = BoxLayout(
            orientation='vertical',
            size_hint_y=None,
            height=40,
            padding=[5, 5]
        ...
        with lead_sheet_title_box.canvas.before:
            Color(0.4, 0.8, 1.0, 1)  # Bright baby blue background
            self.lead_sheet_title_bg = Rectangle(pos=lead_sheet_title_box.pos, size=lead_sheet_title_box.size)
        
        lead_sheet_title_box.bind(size=self._update_lead_sheet_title_bg, pos=self._update_lead_sheet_title_bg)
        ...
        lead_sheet_title = Label(
            ...
            font_size='20sp',
            bold=True,
            color=(0.1, 0.1, 0.1, 1),  # Dark text for contrast against bright blue
            size_hint_y=None,
            height=40
        )
        lead_sheet_title_box.add_widget(lead_sheet_title)
        controls_container.add_widget(lead_sheet_title_box)
    ...
    def _update_lead_sheet_title_bg(self, instance, value):
        """Update the lead sheet title background rectangle"""
        self.lead_sheet_title_bg.pos = instance.pos
        self.lead_sheet_title_bg.size = instance.size
