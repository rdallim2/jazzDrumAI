...
# Define the bar count as global and add a callback mechanism for UI updates
bar_count = 0
...
def play_bar(fs, time_per_beat, channel=9):
    ...
    # Notify about the bar start - do this BEFORE playing the notes
    ...
    # Increment the bar count AFTER finishing the bar
    bar_count += 1
